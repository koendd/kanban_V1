                ...
                <div class="card-body">
                    <form action="{{route('createStatus', $kanbanBoard->id)}}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('description') is-invalid @enderror" id="inputDescription" name="description" maxlength="1000" rows="4" autocomplete="off" onkeyup="displayCharCount(this, 'charCount')" placeholder="max 1000 characters are allowed">{{old('description')}}</textarea>
