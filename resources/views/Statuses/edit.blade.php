                ...
                <div class="card-body">
                    <form action="{{route('editStatus', [$kanbanBoard->id, $status->id])}}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control @error('description') is-invalid @enderror" id="inputDescription" name="description" maxlength="1000" rows="4" autocomplete="off" onkeyup="displayCharCount(this, 'charCount')" placeholder="max 1000 characters are allowed">{{$status->description}}</textarea>

                                @error('description')
                                <div class="invalid-feedback">
                                    Please provide a status description.
                                </div>
                                @enderror
